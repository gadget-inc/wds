...
const throttledRequireFlush = lodash_1.throttle(() => {
    try {
        const request = http.request({ socketPath: process.env["ESBUILD_DEV_SOCKET_PATH"], path: "/file-required", method: "POST", timeout: 200 }, () => {
...
if (!workerData || !workerData.isESBuildDevWorker) {
