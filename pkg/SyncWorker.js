...
class SyncWorker {
    constructor(scriptPath) {
        ...
        utils_1.log.debug("booted syncworker worker", { filename: __filename, scriptPath, childWorkerThreadId: this.worker.threadId });
    ...
    call(...args) {
        ...
        utils_1.log.debug("calling syncworker", { thisThreadId: worker_threads_1.threadId, childWorkerThreadId: this.worker.threadId, call });
