...
const wds = async (options) => {
    ...
    const workDir = await fs_1.promises.mkdtemp(path_1.default.join(os_1.default.tmpdir(), "wds"));
    ...
    const compiler = options.useEsbuild ? new EsBuildCompiler_1.EsBuildCompiler(workspaceRoot, workDir) : new SwcCompiler_1.SwcCompiler(workspaceRoot, workDir);
