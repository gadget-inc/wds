...
exports.compileInLeaderProcess = void 0;
...
const compileInLeaderProcess = async (filename) => {
    return await new Promise((resolve, reject) => {
        const request = http_1.default.request({ socketPath: process.env["ESBUILD_DEV_SOCKET_PATH"], path: "/compile", method: "POST", timeout: 200 }, (resp) => {
            let data = "";
